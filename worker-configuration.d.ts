/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 03a41ccfbd12127a1f6e7c0120a0807b)
// Runtime types generated with workerd@1.20250927.0 2025-10-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/cmd/server/index");
	}
	interface Env {
		LINE_CHANNEL_ACCESS_TOKEN: string;
		LINE_CHANNEL_SECRET: string;
		SPREADSHEET_CLIENT_EMAIL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LINE_CHANNEL_ACCESS_TOKEN" | "LINE_CHANNEL_SECRET" | "SPREADSHEET_CLIENT_EMAIL" | "SPREADSHEET_PRIVATE_KEY" | "SPREADSHEET_ID">> {}
}
